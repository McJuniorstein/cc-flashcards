...
| 2 | Elements of Information Security<br>7                                                                    |  |  |
...
|   | 7.1.2 Authorization of Products to Operate in Similar Situation | า39 |
...
|    | 9.2.2       | Deciding between Software, Hardware, or Firmware Implementat |    |
|    | 0.00        | Managina IZana                                               |    |
|    |             | Managing Keys                                                |    |
|    |             | Security of Cryptographic Modules                            |    |
|    |             | Applying Cryptography to Networks                            |    |
|    |             | Complying with Export Rules                                  |    |
|    |             | pendenciesonsiderations                                      |    |
|    |             | Direct Costs                                                 |    |
|    |             | Indirect Costs                                               |    |
| 10 |             | milies                                                       |    |
| 10 |             | ss Control (AC)                                              |    |
|    |             | eness and Training (AT)                                      |    |
|    |             | and Accountability (AU)                                      |    |
|    |             | ssment, Authorization, and Monitoring (CA)                   |    |
|    |             | guration Management (CM)                                     |    |
|    |             | ngency Planning (CP)                                         |    |
|    |             | fication and Authentication (IA)                             |    |
|    |             | dual Participation (IP)                                      |    |
|    | 10.9 Incide | ent Response (IR)                                            | 64 |
|    | 10.10 Mair  | ntenance (MA)                                                | 64 |
|    | 10.11 Med   | ia Protection (MP)                                           | 65 |
|    | 10.12 Priva | acy Authorization (PA)                                       | 65 |
|    | 10.13 Phys  | sical and Environmental Protection (PE)                      | 66 |
|    | 10.14 Plan  | ning (PL)                                                    | 67 |
|    | 10.15 Prog  | ram Management (PM)                                          | 67 |
|    | 10.16 Pers  | sonnel Security (PS)                                         | 68 |
...
<span id="page-84-0"></span>[SP800- NIST Special Publication (SP) 800-175B, *Guideline for Using* 

175B] *Cryptographic Standards in the Federal Government: Cryptographic Mechanisms*, National Institute of Standards and Technology, Gaithersburg, Maryland, March 2016, 81pp.<https://doi.org/10.6028/NIST.SP.800-175B>
...
support critical infrastructure applications or are paramount to
...
security risk to organizational operations (including mission, functions, image, reputation), organizational assets, individuals, other organizations, and the Nation, and includes: (i) establishing the context for risk-related activities; (ii) assessing risk; (iii) responding

to risk once determined; and (iv) monitoring risk over time.

SOURCE: SP 800-39

Risk Management A structured approach used to oversee and manage risk for an

enterprise.

SOURCE: CNSSI-4009

Role A job function or employment position to which people or other
...
(i.e., confidentiality, integrity, and availability) specified for a system. Safeguards may include security features, management constraints, personnel security, and security of physical structures,

areas, and devices. Synonymous with security controls and
...
that is uniquely associated with one or more entities and should not
